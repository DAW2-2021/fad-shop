...
<div class="container-fluid container-md my-5 p-2 p-sm-5 overflow-hidden">
    ...
    <div class="row d-sm-flex d-none categories justify-content-center align-items-center mt-2">
        @for ($i = 0; $i < 6; $i++) <a href="{{ route('categories.show', $categories[$i]->slug) }}" class="category row text-decoration-none m-2 px-1 py-4 rounded flex-column justify-content-center align-items-center">
            <i class="{{ $categories[$i]->icon }} text-center"></i>
            <h5 class="text-center mt-1">{{ $categories[$i]->name }}</h5>
            <div class="row"></div>
            </a>
            @endfor
            <a href="#" class="category row text-decoration-none m-2 px-1 py-4 rounded flex-column justify-content-center align-items-center" data-bs-toggle="modal" data-bs-target="#categoriesModal">
    ...
    <div class="container-fluid container-md">
        <div class="row justify-content-center align-content-center">
            ...
            <div class="d-flex flex-wrap justify-content-center align-items-center">
                ...
                <a href="{{ route('shop.product.show', [$product->shop->slug, $product->slug]) }}" class="card card-product border text-white position-relative mb-5 p-0">
                    ...
                    <div class="card-stars text-warning position-absolute top-0 end-0 p-1">
                        ...
                        <i class="far fa-star"></i>
                        <i class="far fa-star"></i>
                        @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 0.5) <i class="fa fa-star-half-alt"></i>
                            <i class="far fa-star"></i>
                            <i class="far fa-star"></i>
                            <i class="far fa-star"></i>
                            <i class="far fa-star"></i>
                            @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 1) <i class="fas fa-star">
                                </i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 1.5) <i class="fas fa-star"></i>
                                    <i class="fa fa-star-half-alt"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 2) <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="far fa-star"></i>
                                        <i class="far fa-star"></i>
                                        <i class="far fa-star"></i>
                                        @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 2.5) <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fa fa-star-half-alt"></i>
                                            <i class="far fa-star"></i>
                                            <i class="far fa-star"></i>
                                            @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 3) <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="far fa-star"></i>
                                                <i class="far fa-star"></i>
                                                @elseif (round($product->opinions()->avg('score'), 2) / 2 <= 3.5) <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                                                    <i class="fa fa-star-half-alt"></i>
                                                    <i class="far fa-star"></i>
                    ...
                    <h5 class="position-absolute mh-25 w-75 text-center top-100 start-50 translate-middle card-title bg-dark ms-0 rounded-pill px-3 py-2">
                        {{ $product->name }}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body categories d-flex justify-content-center flex-wrap align-content-center">
                ...
                <a href="{{ route('categories.show', $category->slug) }}" class="category row text-decoration-none m-2 px-1 py-4 rounded flex-column justify-content-center align-items-center">
